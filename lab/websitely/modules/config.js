const PALETTES = [
  { name: "Midnight Pop", colors: ["#0b1020", "#2f5bea", "#38bdf8", "#c8ff36"] },
  { name: "Ink Coral", colors: ["#111827", "#334155", "#fb7185", "#f97316"] },
  { name: "Forest Gold", colors: ["#0f2f24", "#2f5d46", "#facc15", "#d97706"] },
  { name: "Lavender Tech", colors: ["#1e1b4b", "#7c3aed", "#c4b5fd", "#22d3ee"] },
  { name: "Desert Luxe", colors: ["#2b2118", "#a16207", "#facc15", "#f2b880"] },
  { name: "Blue Steel", colors: ["#0b1220", "#475569", "#60a5fa", "#f8fafc"] },
  { name: "Cream Studio", colors: ["#fff7ed", "#111827", "#f97316", "#2563eb"] },
  { name: "Fresh Paper", colors: ["#ffffff", "#0f172a", "#22c55e", "#6366f1"] },
  { name: "Soft Product", colors: ["#f8fafc", "#1d4ed8", "#14b8a6", "#f43f5e"] },
  { name: "Warm Local", colors: ["#fff1e6", "#3f2e2a", "#c76f42", "#f2b880"] },
  { name: "Wellness Sage", colors: ["#f4f7ed", "#243528", "#6b8f71", "#d8c3a5"] },
  { name: "Gallery Light", colors: ["#fffaf0", "#18181b", "#e11d48", "#fbbf24"] },
  { name: "Clean SaaS", colors: ["#f5f7ff", "#111827", "#2457ff", "#a3e635"] },
  { name: "Mono Electric", colors: ["#0a0a0a", "#fafafa", "#a3e635", "#06b6d4"] },
  { name: "Rose Cloud", colors: ["#fff1f2", "#881337", "#fb7185", "#8b5cf6"] }
];
